...
<body>
	<center>
		<form action="doupdatetg.do" id="inserttg" method="post"
			...
			<input type="hidden" name="created" value="${tg.created}">
				<input type="hidden" name="goodname"
					value="${tg.goodname}">
				<input type="hidden" name="price" value="${tg.price}">
				<input type="hidden" name="content" value="${tg.content}">
				<input type="hidden" name="classify" value="${tg.classify}">
				<input type="hidden" name="place"
					value="${tg.place}">
				<input type="hidden" name="publishdate"
					value="<fmt:formatDate value="${tg.publishdate}" pattern="yyyy-MM-dd" />">
				<input type="hidden" name="phone" value="${tg.phone}">
