		...
		<div class="main-w3layouts center-container">
			...
			<div class="main-agileinfo">
				<div class="agileits-top">
					<form action="torecordLogin.do" method="post" id="loginForm">
						<i class="fa fa-user-o" aria-hidden="true"></i> <input
							class="text w3lpass" type="text" name="username"
						...
						<div class="wthree-text">
							...
							<label class="anim"><a href="forgetPwdLogin.do">
									<p style="font-family: \5FAE\8F6F\96C5\9ED1; font-size: 100%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										忘记密码?</p></a>
										<a href="getactivationLogin.do">
									<p style="font-family: \5FAE\8F6F\96C5\9ED1; font-size: 100%;color: pink">
										&nbsp;&nbsp;
										重新激活账号?</p>
							</a>
							</label>
							...
							<div class="w3layouts_more-buttn">
								<h3>
									没有账号? <a href="toRegisterLogin.do">
