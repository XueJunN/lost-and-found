...
<body>
	<center>
		<form action="updatefgs.do" id="inserttg" method="post"
			...
			<ol>
				<li>失物名：<input type="text" name="goodname"
					value="${fg.goodname}"><br>
				</li>
				<li>内容：<input type="text" name="content" value="${fg.content}"><br>
				</li>
				...
				<li><br> 丢失地点：<input type="text" name="place"
					value="${fg.place}"><br></li>
				<li>联系电话：<input type="text" name="phone" value="${fg.phone}"><br>
				</li>
