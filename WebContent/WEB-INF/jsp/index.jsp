...
<body>
			...
			<div class="hero-single-slide ">
				<div class="hero-slider-item bg-img"
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="hero-slider-content slide-1"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="hero-single-slide">
				<div class="hero-slider-item bg-img"
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="hero-slider-content slide-2"></div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="paginatoin-area text-center">
		...
		<p>
			<a
				href="toLogin.do?pno=${page.navigateFirstPage}&&goodname=${goodname}">首页</a>&nbsp;
			<a
				href="toLogin.do?pno=${page.hasNextPage ? page.nextPage:page.navigateLastPage}&&goodname=${goodname}">下页</a>&nbsp;
			<a
				href="toLogin.do?pno=${page.hasPreviousPage ? page.prePage:page.navigateFirstPage}&&goodname=${goodname}">上页</a>&nbsp;
			<a
				href="toLogin.do?pno=${page.navigateLastPage}&&goodname=${goodname}">末页</a>&nbsp;
			当前页${page.size}条数据,总条数为:${page.total},当前第${page.pageNum}页/共${page.pages}页
		</p>
	</div>
	<!-- end pagination area --> <!-- page main wrapper end --> </main>
	<!-- main wrapper end -->
						...
						<div class="row">
							<div class="col-lg-5 col-md-5">
								<div class="product-large-slider">
									<div class="pro-large-img">
										<img src="assets/img/product/${t.picture}"
											alt="product-details" />
									</div>
								</div>
							</div>
							<div class="col-lg-7 col-md-7">
								<div class="product-details-des quick-details">
									<h3 class="product-name">${t.goodname}</h3>
									...
									<p class="pro-desc">${t.content}</p>
									<div class="quantity-cart-box d-flex align-items-center">
									</div>
									<div class="useful-links">
										<a href="#" data-toggle="tooltip" title="Compare"><i
											class="lnr lnr-sync"></i>刷新</a> <a href="#"
											data-toggle="tooltip" title="Wishlist"><i
											class="lnr lnr-heart"></i>收藏</a>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="offcanvas-search-inner">
			...
			<div class="container">
				<div class="offcanvas-search-box">
					<form action="toLogin.do" class="d-flex bdr-bottom w-100"
						method="post">
	...
	<!-- <div class="letter-w3ls">
				<form name="uploadFileForm" id="inserttg" action="toupdateuser.do"
					...
					<input type="hidden" name="password" id="password"
						onblur="checkpas1();" value="${sessionScope.user.password}" /> <input
						type="hidden" name="repassword" id="repassword"
						onChange="checkpas();" value="${sessionScope.user.repassword}" />
					<ol>
				...
				<form name="uploadFileForm" id="inserttg" action="toupdateuser.do"
					...
					<ol>
						<li><label for="password">密码</label> <input type="password"
							name="password" id="password" onblur="checkpas1();" value="" /></li>
