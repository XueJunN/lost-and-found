...
<body>
						...
						<div class="row">
							<div class="col-lg-5">
								<div class="product-large-slider">
									<div class="pro-large-img img-zoom">
										<img src="assets/img/product/${tg.picture}"
							...
							<div class="col-lg-7">
								<div class="product-details-des">
									<c:if test="${tg.price>0}">
										<p class="img">
											<img alt="" src="images/xuanshan.jpg" height="80" width="130">
										</p>
									</c:if>
									<h3 class="product-name">${tg.goodname}</h3>
									<div class="ratings d-flex"></div>
									<p class="pro-desc">类型：${tg.classify}</p>
									<p class="pro-desc">赏金：${tg.price}</p>
									<p class="pro-desc">丢失地点：${tg.place}</p>
									<p class="pro-desc">
										时间：
										<fmt:formatDate value="${tg.publishdate}" pattern="yyyy-MM-dd" />
									</p>
									<p class="pro-desc">描述：${tg.content}</p>
									<div class="useful-links">
										<a href="#" data-toggle="tooltip" title="刷新"><i
											class="lnr lnr-sync"></i>刷新</a> <a href="#" data-toggle="tooltip"
											title="收藏"><form action="doinsertcollect.do">
												<input type="hidden" name="goodname" value="${tg.goodname}">
												<input type="hidden" name="content" value="${tg.content}">
												<input type="hidden" name="picture" value="${tg.picture}">
												<input type="hidden" name="uid"
													value="${sessionScope.user.uid}"> <input
													type="hidden" name="tgid"
													value="${sessionScope.throwGoods.tgid}"> <i
								...
								<div class="product-review-info">
									...
									<div class="tab-content reviews-tab">
										...
										<div class="tab-pane fade" id="tab_three">
											<form action="insertInfo.do" class="review-form">
												...
												<input type="hidden" name="uid"
													value="${sessionScope.user.uid}"> <input
													type="hidden" name="tgid"
													value="${sessionScope.throwGoods.tgid}">
												<center>
	...
	<div id="content" class="popup-effect">
		<div class="popup">
			<!--login form-->
			<div class="letter-w3ls">
				<form name="uploadFileForm" id="inserttg" action="insertcontanct.do"
					method="post">
					<ol>
						...
						<input type="hidden" name="tgid"
							...
							value="${sessionScope.throwGoods.phone}">
