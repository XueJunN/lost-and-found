		...
		<div class="main-w3layouts center-container">
			...
			<div class="main-agileinfo">
				<div class="agileits-top">
					<form action="toRegisterAdminLogin.do" method="post">
						<i class="fa fa-user-o" aria-hidden="true"></i> <input
							class="text" type="text" name="name" placeholder="用户名"
							...
							required="true"> <input class="text" type="password"
							name="statuscode" placeholder="激活码" required="">
						<div class="wthree-text">
							...
							<div class="w3layouts_more-buttn">
								<h3>
									已有账号? <a href="toadminloginLogin.do"><p
											style="font-family: \5FAE\8F6F\96C5\9ED1; font-size: 180%">登录</p>
									</a>
								</h3>
							</div>
					</form>
